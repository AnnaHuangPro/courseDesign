...
public class Ddd3TestServiceBean extends BaseService implements Ddd3TestService
{
	...
	{
		Ddd3Test ddd3Test = new Ddd3Test();
		ddd3Test.setNameSpelling("dddd");
		ddd3Test.setDegree("dddd");
		ddd3Test = this.saveDdd3Test(ddd3Test);
		SessionFactory.commitTransaction();
		System.out.println(ddd3Test.getNameSpelling());
	}

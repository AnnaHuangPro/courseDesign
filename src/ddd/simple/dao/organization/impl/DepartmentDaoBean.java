...
public class DepartmentDaoBean extends BaseDao implements DepartmentDao
{
	...
	public EntitySet<Department> findAllDepartment() throws Exception {
		return this.query("1=1",Department.class);
	}

	@Override
	public EntitySet<Department> findDepartmentByLoginOrg(Long orgId) throws Exception {
		String sql="1=1 and organizationId="+orgId;
		return this.query(sql,Department.class);
	}
}

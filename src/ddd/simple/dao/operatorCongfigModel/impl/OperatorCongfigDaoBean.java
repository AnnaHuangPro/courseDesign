...
@Service
public class OperatorCongfigDaoBean extends BaseDao implements
		OperatorCongfigDao {
	@Override
	...
	public int updateOperatorCongfig(Long operatorId, String cCkey,
			Map<String, Object> operatorcongfigMap) throws Exception {
		String whereSql = "operatorId = " + operatorId + " and cCkey = '"
				+ cCkey + "'";
	...
	public OperatorCongfig findOneByCondition(String where) {
		try {
			SessionFactory.getThreadSession().clearByEntityName(
					OperatorCongfig.class);
	...
	public void deleteOperatorCongfigByKey(String cCkey) throws Exception {
		String where = " cCkey = '" + cCkey + "' ";
		deleteByWhere(where, OperatorCongfig.class);
	}
}

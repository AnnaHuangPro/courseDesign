...
public class Module extends Entity implements Serializable {
	...
	@Column(name = "parentId", label = "父级模块", FKName = "module_FK_module")
	...
	public EntitySet<Permission> getPermissions()
	{
		return permissions;
	}

	public void setPermissions(EntitySet<Permission> permissions)
	{

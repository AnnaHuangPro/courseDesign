...
public class ModelFileAction
{
	...
	public List<StatsReport> getAllReportFormGroupByType(){
		try{
			List<StatsReport> statsReports = this.modelFileService.getAllReportFormGroupByType();
			List<StatsReport> result = new ArrayList<StatsReport>();
			
			for(StatsReport statsReport: statsReports) {
				if(!"图表数据统计".equals(statsReport.getName())) {
	...
	public List<StatsReport> getAllReportFormGroupByType2(){
		try{
			List<StatsReport> statsReports = this.modelFileService.getAllReportFormGroupByType();
			List<StatsReport> result = new ArrayList<StatsReport>();

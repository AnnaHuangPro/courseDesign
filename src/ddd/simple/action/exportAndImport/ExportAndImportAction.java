...
public class ExportAndImportAction
{
	...
	public Map<String, String> importDataFile(String importConfigKey, String formId)
	{
		try
		{
			...
			EntitySet<Attachment> attachments = this.attachmentService.findAttachmentByForm(formId, "导入excel");
	...
	public void importEntityByImportConfig(String importConfigKey)
	{
		try
		{
			ImportConfigs importConfig = this.importConfigsService.findImportConfigByKey(importConfigKey);
			String configContext = importConfig.getConfigContext();
			EntitySet<Attachment> attachments = this.attachmentService.findAttachmentByForm(importConfig.getAttachmentCode(),
	 ...
	 * @return void
	 */
	public void importByAttachment(String associateFormId, String associateFormName)
	{
		try
		{

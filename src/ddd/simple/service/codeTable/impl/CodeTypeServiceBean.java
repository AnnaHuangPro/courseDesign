...
public class CodeTypeServiceBean extends BaseService implements CodeTypeService
{
	...
	{
		try {
			this.doLog(CodeType.class, "编码："+codeType.getCode()+";唯一编码："+codeType.getCodeTypeKey()+";类型名："+codeType.getName(), "新增");
	...
	public int deleteCodeType(Long codeTypeId) {
		try {
			CodeType codeType=this.codeTypeDao.findCodeTypeById(codeTypeId);
			this.doLog(CodeType.class, "编码："+codeType.getCode()+";唯一编码："+codeType.getCodeTypeKey()+";类型名："+codeType.getName(), "删除");
	...
	public CodeType updateCodeType(CodeType codeType) {
		try {
			this.doLog(CodeType.class, "编码："+codeType.getCode()+";唯一编码："+codeType.getCodeTypeKey()+";类型名："+codeType.getName(), "修改");

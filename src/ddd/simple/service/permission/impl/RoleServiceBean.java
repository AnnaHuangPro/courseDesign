...
public class RoleServiceBean  implements RoleService
{
	...
	public int deleteRole(Long roleId) throws Exception {
		try {
			this.operatorAndRoleDao.deleteByRoleId(roleId); // 删除后台角色关联
//			this.memberTypeService.deleteMemberTypeByRoleId(roleId); // 删除前台角色关联
	...
	public Role findRoleByCode(String code){
		try
		{
			return this.roleDao.findRoleByCode(code);
		} catch (Exception e)
		{
			e.printStackTrace();
			throw new DDDException("findRoleByCode", e.getMessage(), e);
		}
	}
	...
	public EntitySet<Role> findRolesByRoleType(String roleType) throws Exception {
		try
		{
			return this.roleDao.findRolesByRoleType(roleType);
		} catch (Exception e)
		{
			e.printStackTrace();
			throw new DDDException("findRoleByCode", e.getMessage(), e);
	...
	public EntitySet<Role> findRoleByOperatorId(Long operatorId) throws Exception{
		try {
			return this.roleDao.findRoleByOperatorId(operatorId);
		} catch (Exception e) {
			e.printStackTrace();
			throw new DDDException("findRoleByOperatorId", e.getMessage(), e);
		}
	}
}

...
import ddd.base.dynamicSql.extend.DynamicSqlExtendsInterface;
...
public class DynamicService
{
	...
	public static InternalParamHandler			internalParamHandler	= (InternalParamHandler) SpringContextUtil
			.getBean("internalParamHandler");
	public static DynamicSqlExtendsInterface	extend = null;		
	static{
		if(SpringContextUtil.containsBean("dynamicSqlExtendsBean")){
			extend = (DynamicSqlExtendsInterface) SpringContextUtil.getBean("dynamicSqlExtendsBean");
		}
	}
	public static String getDynamicSql(String stringTemplate, Map<String, Object> map) throws Exception
	{
		if (stringTemplate == null || "".equals(stringTemplate.trim()))
			return stringTemplate;
			
		map = internalParamHandler.addInternalParam(map);
		if (extend != null)
		{
			map.putAll(extend.addNormalParams());
		}

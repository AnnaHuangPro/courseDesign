...
public abstract class Entity implements Serializable{
	...
	/**
	 * 输入码用于支持拼音搜索 ，这条语句是手动设置拼音的sql语句UPDATE codetable SET inputCode = to_pinyin(name)
	 */
	@Column(name="inputCode",label="输入码",length=255)
	...
	@Column(name="attachmentCode",label="附件编码")

...
import ddd.base.dynamicSql.util.DateFormat;
import ddd.base.dynamicSql.util.HasPermission;
...
public class VelocityUtil {
	...
	private static HasPermission hasPermission = new HasPermission();
	...
	public static void generate(String stringTemplate,Writer writer,Map<String, Object> map)
	{
        ...
        velocityContext.put("control", hasPermission);

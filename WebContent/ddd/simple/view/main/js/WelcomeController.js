...
.controller(	"ddd3portletController",["$rootScope","$scope","$state","angularPermission",
	function($rootScope, $scope,$state,angularPermission) {
	var employee = angularPermission.getLoginUser().employee;
	var role = employee.remark;
	if(role == "teacher"){
		$scope.buttons = [
            {label:"我负责的课程设计",icon:"codegenerate",state:"main.list.courseDesign.courseDesignList"},
            {label:"学生进度",icon:"reportview",state:"main.list.stuCourseProgress.stuCourseProgressList"},
            {label:"个人信息管理",icon:"employee",state:"main.list.personalData.personalDataDisplay"}];
	}else if(role == "student"){
		$scope.buttons = [
			{label:"课程设计选题",icon:"choose",state:"main.list.stuCourseProgress.stuChooseCourseList"},
            {label:"我的课程设计",icon:"codegenerate",state:"main.list.courseDesign.courseDesignList"},
            {label:"我的进度",icon:"reportview",state:"main.list.stuCourseProgress.stuCourseProgressList"},
            {label:"个人信息管理",icon:"employee",state:"main.list.personalData.personalDataDisplay"}];
	}else if(role == "manager"){
		$scope.buttons = [
			{label:"教师信息管理",icon:"employee",state:"main.list.teacher.teacherList"},
            {label:"学生信息管理",icon:"employee",state:"main.list.student.studentList"},
            {label:"专业信息管理",icon:"choose",state:"main.list.major.majorList"},
            {label:"消息管理",icon:"modelfile",state:"main.list.sendMessage.sendMessageList"}];
	}

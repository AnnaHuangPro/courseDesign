...
public class AttachmentGroupItemServiceBean extends BaseService implements AttachmentGroupItemService
{
	...
	{
		try {
			attachmentGroupItem=this.dealAttachmentGroupItem(attachmentGroupItem);
	...
	private AttachmentGroupItem dealAttachmentGroupItem(AttachmentGroupItem attachmentGroupItem){
		String code=attachmentGroupItem.getGroupItemCode();
		String[] codes=code.split("[.]");
		
		attachmentGroupItem.setTitleLevel(codes.length);
		if(attachmentGroupItem.getEnable() == null){
			attachmentGroupItem.setEnable(true);
		}

...
public class ModelDaoBean extends BaseDao implements ModelDao
{
	...
	@Override
	public int deleteModelTable(Model model) throws Exception{
		String sql = "drop table "+model.getModelEnglishName()+"";
	...
	@Override
	public EntitySet<Model> getSubmitedModel() throws Exception {
		String sqlWhere = "state = '已提交'";
		return this.query(sqlWhere,Model.class);
	}

...
public class Model extends Entity implements Serializable
{
	...
	@Column(name = "parentId", composition = false, FKName = "MD_FK_MD")
	private Model parentModel;
	
	@Column(joinColumn = "modelId", composition = true)
	private EntitySet<ModelJointUnique> jointUnique;
	
	public EntitySet<ModelJointUnique> getJointUnique()
	{
		lazyLoad("jointUnique");
		return jointUnique;
	}

	public void setJointUnique(EntitySet<ModelJointUnique> jointUnique)
	{
		super.LazyFieidsLoaded.put("jointUnique", true);
		this.jointUnique = jointUnique;
	}

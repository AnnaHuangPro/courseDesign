 ...
 * @example
 * ```javascript
 * editor.execCommand( 'foreignkey');
 * ```
 */
UE.plugins['foreignkey'] = function () {
    var me = this,thePlugins = 'foreignkey';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/foreignkey.html',
                name:thePlugins,
                editor:this,
                title: '外键',
    ...
    me.addListener( 'mouseover', function( t, evt ) {
        ...
        if ( /img/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
            var html = popup.formatHtml(
                '<nobr>外键: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
            if ( html ) {
 ...
 * @example
 * ```javascript
 * editor.execCommand( 'codetable');
 * ```
 */
UE.plugins['codetable'] = function () {
    var me = this,thePlugins = 'codetable';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/codetable.html',
                name:thePlugins,
                editor:this,
                title: '码表',
                cssRules:"width:600px;height:450px;",
    ...
    me.addListener( 'mouseover', function( t, evt ) {
        ...
        if ( /img/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
            var html = popup.formatHtml(
                '<nobr>码表: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
            if ( html ) {
                popup.getDom( 'content' ).innerHTML = html;
                popup.anchorEl = el;
                popup.showAnchor( popup.anchorEl );
...
UE.plugins['fileupload'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/fileupload.html',
                name:thePlugins,
                editor:this,
                title: '文件上传',
                cssRules:"width:600px;height:450px;",
...
UE.plugins['datetime'] = function () {
	...
	me.addListener( 'mouseover', function( t, evt ) {
		...
		if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
			var html = popup.formatHtml(
				'<nobr>日期: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
			if ( html ) {
				popup.getDom( 'content' ).innerHTML = html;
				popup.anchorEl = el;
				popup.showAnchor( popup.anchorEl );
 ...
 * @example
 * ```javascript
 * editor.execCommand( 'richtext');
 * ```
 */
UE.plugins['richtext'] = function () {
	var me = this,thePlugins = 'richtext';
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/richtext.html',
				name:thePlugins,
				editor:this,
				title: '富文本',
				cssRules:"width:600px;height:310px;",
	...
	me.addListener( 'mouseover', function( t, evt ) {
		...
		if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
			var html = popup.formatHtml(
				'<nobr>富文本: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
			if ( html ) {
				popup.getDom( 'content' ).innerHTML = html;
				popup.anchorEl = el;
				popup.showAnchor( popup.anchorEl );

...
public class AttachmentGroupTemplateServiceBean extends BaseService implements AttachmentGroupTemplateService
{
	...
	@Override
	public EntitySet<AttachmentGroupTemplate> findAttachmentGroupTemplateByCategory(String categoryCode) {
		try{
			return this.attachmentGroupTemplateDao.findAttachmentGroupTemplateByCategory(categoryCode);
		}catch (Exception e) {
			e.printStackTrace();
			throw new DDDException("findAttachmentGroupTemplateByCategory", e.getMessage(), e);
		}
	}

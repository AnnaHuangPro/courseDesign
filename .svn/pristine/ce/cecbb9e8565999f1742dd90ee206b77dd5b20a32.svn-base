...
function(a) {
    ...
    c.prototype.getCalculatedOffset = function(a, b, c, d) {
    	var bLeft = b.left - c;
    	var testLeft = bLeft > 20 ? bLeft : 20;
        return "bottom" == a ? {
            top: b.top + b.height,
...
function(a) {
    ...
    c.prototype.setContent = function() {
        ...
        b = this.getTitle(),
        c = this.getContent();
        a.find(".popover-title")[this.options.html ? "html": "text"](b+'<button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="closePopover(this)"><span aria-hidden="true">×</span></button>'),

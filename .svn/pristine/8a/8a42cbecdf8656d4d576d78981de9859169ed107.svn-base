...
public class MemberDaoBean extends BaseDao implements MemberDao
{
	...
	public Member findMemberByOnlyCodeAndPassword(String onlyCode, String password) throws Exception {
		String sqlCheck = "onlyCode = '"+onlyCode+"' and password = '"+password+"'";

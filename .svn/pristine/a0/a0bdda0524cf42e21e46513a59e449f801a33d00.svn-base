...
import ddd.base.jxls.ExcelToHtmlConverter;
...
public class Excel2HtmlUtil {
	...
	public static void main(String[] args) {
		...
		try {
			testHtml( new File("D:\\temp\\Book1.xlsx") );
		} catch (Exception e) {
    ...
    public static void toHtml(InputStream input,OutputStream output) throws Exception
    {
        HSSFWorkbook workbook;
        try
        {

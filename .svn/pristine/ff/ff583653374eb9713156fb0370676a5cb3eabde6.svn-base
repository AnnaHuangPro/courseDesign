...
//	private Ehcache cache;
	...
	public Set<Map<String, Object>> findCheckOptionByFormIdAndFormType(Long formId,String formType) 
	{
		try
		{
			String sql = "select checkPeople,taskName,checkTime,checkResult,managerOption from checkOption o where o.formId =" + formId + " and o.formType = '" + formType + "' order by o.checkTime asc";
			return this.checkOptionDao.query(sql);
		}
		catch(Exception e)
		{

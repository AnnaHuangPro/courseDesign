...
public class AttachmentAction {
	...
	public EntitySet<Attachment> findAttachmentByForm(String associateFormId,
	...
	public void deleteAttachmentByForm(String associateFormId,String associateFormName) throws Exception {
		try {

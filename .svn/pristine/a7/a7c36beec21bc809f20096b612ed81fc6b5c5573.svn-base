...
public class BaseDao implements BaseDaoInterface {
	...
	@Override
	public Set<Map<String, Object>> queryNoDynamicSql(String selectSql) throws Exception {
		Session session = SessionFactory.getThreadSession();
		return session.get(selectSql,new Object[]{},null);
	}
	
	@Override
	public List<Map<String,Object>> queryProcedure(String sql) throws Exception {
		Session session = SessionFactory.getThreadSession();
		return session.getResultByProcedure(sql);
	}
}
